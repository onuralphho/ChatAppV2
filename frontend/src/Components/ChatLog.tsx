...
const ChatLog = (props: IProps) => {
	...
	const sendMessageHandler = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		console.log("SendMessage invoke", sendMessagePayload);
		await ctx?.connection?.invoke("SendMessage", sendMessagePayload);
	...
	return (
		<div className=" bg-[#363636]    flex-1  flex flex-col  h-full fade-in">
			...
			<div className={`flex flex-1 flex-col h-20 gap-2 w-full overflow-y-scroll  px-2   pb-2 `}>
